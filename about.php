...
<!-- Mirrored from themesflat.co/html/vitour/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 10:18:59 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>Srilanka
                                                        USA</span>
                                                    <h3 class="title-tour-list"><a href="tour_single4.php">6 nights From
                                                            Srilanka</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>Switzerland
                                                        USA</span>
                                                    <h3 class="title-tour-list"><a href="tour_single.php">6 nights From
                                                            Switzerland</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>Thailand
                                                        USA</span>
                                                    <h3 class="title-tour-list"><a href="tour1_single.php">6 nights From
                                                            Thailand</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>United Kingdom
                                                        USA</span>
                                                    <h3 class="title-tour-list"><a href="tour2_single.php">6 nights From
                                                            United Kingdom</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>Hong Kong
                                                        USA</span>
                                                    <h3 class="title-tour-list"><a href="tour3_single.php">6 nights From
                                                            Hong Kong</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                        ...
                        <div class="row relative z-index3">
                            <div class="col-lg-12">
                                <div class="instagram-post-grid">
                                    <a href="https://www.instagram.com/" class="tf-instagram relative overflow-hidden">
